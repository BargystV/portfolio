...
- **Каждый интерфейс, тип, функцию, компонент и экспортируемую константу** необходимо документировать JSDoc-комментарием `/** ... */` на русском языке
- Важную логику внутри функций сопровождать inline-комментарием `//` на русском языке
